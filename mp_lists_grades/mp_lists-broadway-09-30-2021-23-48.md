...
Expanded: PNG(w=900, h=600, hash=3f643f7814000f7e)
==
...
```
Original: out == expected
Expanded: PNG(w=900, h=600, hash=5d99ad0adc9980)
==
PNG(w=900, h=600, hash=3fa66744920ffb90)
```
...
==124== 
==124== HEAP SUMMARY:
==124==     in use at exit: 96 bytes in 4 blocks
==124==   total heap usage: 2,208 allocs, 2,204 frees, 263,852 bytes allocated
==124== 
==124== 96 (24 direct, 72 indirect) bytes in 1 blocks are definitely lost in loss record 2 of 2
==124==    at 0x4C29EA3: malloc (vg_replace_malloc.c:309)
==124==    by 0x40475CB: operator new(unsigned long) (in /usr/local/lib/libc++abi.so.1.0)
==124==    by 0x42B293: List<int>::insertBack(int const&) (List.hpp:110)
==124==    by 0x439673: ____C_A_T_C_H____T_E_S_T____0() (test_part2_extra.cpp:21)
==124==    by 0x473562: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==124==    by 0x463CB6: Catch::TestCase::invoke() const (catch.hpp:10793)
==124==    by 0x463BEC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==124==    by 0x460146: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==124==    by 0x45E71E: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==124==    by 0x467AB6: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==124==    by 0x466752: Catch::Session::runInternal() (catch.hpp:10149)
==124==    by 0x46641A: Catch::Session::run() (catch.hpp:10106)
==124== 
==124== LEAK SUMMARY:
==124==    definitely lost: 24 bytes in 1 blocks
==124==    indirectly lost: 72 bytes in 3 blocks
==124==      possibly lost: 0 bytes in 0 blocks
==124==    still reachable: 0 bytes in 0 blocks
...
This report was generated for **jeremyl6** using **707dc2d1b97a853c30980e9a66a00d13153f6ae4** (latest commit as of **September 30th 2021, 11:48 pm**)
