...
==136== Command: ./test -r xml "List::reverseNth\ #3"
==136== 
==136== 
==136== HEAP SUMMARY:
==136==     in use at exit: 0 bytes in 0 blocks
==136==   total heap usage: 2,329 allocs, 2,329 frees, 281,392 bytes allocated
==136== 
...
==138== Command: ./test -r xml "List::merge\ #2"
==138== 
==138== 
==138== HEAP SUMMARY:
==138==     in use at exit: 16 bytes in 1 blocks
==138==   total heap usage: 2,359 allocs, 2,358 frees, 283,184 bytes allocated
==138== 
==138== LEAK SUMMARY:
==138==    definitely lost: 0 bytes in 0 blocks
==138==    indirectly lost: 0 bytes in 0 blocks
==138==      possibly lost: 0 bytes in 0 blocks
==138==    still reachable: 16 bytes in 1 blocks
==138==         suppressed: 0 bytes in 0 blocks
==138== Reachable blocks (those to which a pointer was found) are not shown.
==138== To see them, rerun with: --leak-check=full --show-leak-kinds=all
==138== 
...
==140== Command: ./test -r xml "List::sort\ simple\ #3"
==140== 
==140== 
==140== HEAP SUMMARY:
==140==     in use at exit: 0 bytes in 0 blocks
==140==   total heap usage: 2,320 allocs, 2,320 frees, 281,144 bytes allocated
==140== 
